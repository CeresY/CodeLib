...
//		descrip.function("");
		boolean flag = false; //false:����������true:�����ס�
		flag = flag||true;
	...
	public void map() {
		...
		for(String key : keySet) {
			if(("BSCNTY").equals(key)) {
				pracdeList.add("BSCNTY" + map.get(key));//������
				continue;
			}
			if(("BSPAY").equals(key)) {
				pracdeList.add("BSPAY" + map.get(key));//���ʽ
				continue;
			}
			if(("BSREN").equals(key)) {
				pracdeList.add("BSREN" + map.get(key));//������
				continue;
			}
		}
...
//		String str = "BOP/CNCNZ01/Z01CDEFG";
	...
	public void pattern() {
		String str = "less��ismore�����ֲ��ԡ� e[s]ta{bl-is}h<���� �硾���ã��ҡ���.��/����>";
		String regex = "[\\��\\��\\��\\��\\��\\��\\��\\��\\��\\��\\��\\��\\ \\{\\}\\[\\]\\(\\)\\.\\-\\��\\��\\��\\��\\��\\��\\/]";
		String regex2 = "[\\��|\\��|\\��|\\��|\\��|\\��|\\��|\\��|\\��|\\��|\\��|\\��|\\ |\\{|\\}|\\[|\\]|\\(|\\)|\\.|\\-|\\��|\\��|\\��|\\��|\\��|\\��|\\/]";
